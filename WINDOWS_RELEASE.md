...
`REVERSELAB_WINDOWS_UPDATER_SIGNER_SHA256`. Die Production-VST3 enthält genau den
Updater unter `Contents\Helpers\ReverseLabUpdater.exe`. Der MSI-Packager erhält
