...
DISTRIBUTION_ENV = {"REVERSELAB_APPLICATION_IDENTITY": "app",
                    "REVERSELAB_INSTALLER_IDENTITY": "installer",
...
class ReleasePipelineTests(unittest.TestCase):
    ...
    def test_notarized_candidate_retains_logs_and_passes_final_gatekeeper_assessments(self):
        ...
        self.assertEqual(Path(vst3_assessment[-1]).parts[-2:], ("zip-roundtrip", "ReverseLab.vst3"))
